...
int main() {
    ...
    // Output data file
    std::ofstream outputFile("yb174_2d_mot_magnetic_simulation_data.txt");
    ...
    std::cout << "Simulation complete. Optimal parameters data written to yb174_2d_mot_simulation_data.txt" << std::endl;
    return 0;
}